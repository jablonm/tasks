...
<body>
	...
	<div class="container">
		<h2>Podaj dane:</h2>
		<form:form cssClass="form-horizontal" action="add" method="post" commandName="addEmployee">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:select path="department" items="${departments}" cssClass="form-control"></form:select>
